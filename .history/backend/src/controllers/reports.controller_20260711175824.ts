...
export async function getSummary(req: Request, res: Response, businessId: string): Promise<void> {
  try {
    ...
    const result = await OrdersService.getOrders(filters, req.user!.business_idbusinessId)
