...
export function Reports() {
  ...
  const productEntries = useMemo(() => {
    const src = summary?.revenue_by_mineral ?? {}
    return Object.entries(src)
      .map(([product, total]) => ({ product, value: typeof total === 'number' ? total : Number(total) || 0 }))
              ...
              <>
                ...
                <div style={{ backgroundColor: T.white, borderRadius: 20, padding: 24, boxShadow: '0 4px 20px rgba(14,31,31,0.61)', border: `1px solid ${T.mutedCream}60` }}>
                  ...
                  <table style={{ width: '100%', borderCollapse: 'collapse', textAlign: 'left' }}>
                    ...
                    <tbody>
                      {Object.entries(summary?.revenue_by_mineral ?? {}).map(([product, totalAmount]) => (
...
// NOTE: Reports component exported below
